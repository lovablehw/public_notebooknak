-- Modified log_audit_event to allow standard users for specific events
-- Admin-prefixed events are restricted to admins only
...
BEGIN
  ...
  -- Allow ALL authenticated users to log UI interactions
  -- Only restrict administrative event types (prefixed with 'admin_')
